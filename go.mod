...
// Additional outdated third-party dependencies wired in via vuln_usage.go
...
replace github.com/Unknwon/paginater => github.com/unknwon/paginater v0.0.0-20151104151617-7748a72e0141
